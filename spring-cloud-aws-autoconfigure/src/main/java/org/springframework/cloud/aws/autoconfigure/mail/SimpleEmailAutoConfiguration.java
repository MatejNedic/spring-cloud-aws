...
@ConditionalOnClass(value = { AmazonSimpleEmailService.class, MailSender.class }, name = "org.springframework.cloud.aws.autoconfigure.oldmail.SimpleEmailAutoConfiguration")
